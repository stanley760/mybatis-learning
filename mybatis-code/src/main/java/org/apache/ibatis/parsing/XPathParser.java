...
public class XPathParser {
  ...
  /**
   * java xpath 对象 对象，用于查询 XML 中的节点和元素
   */
  private XPath xpath;
   ...
   * @return 返回的XNode对象列表，如果不存在则返回空列表list()
   */
   ...
   *
   * @param expression 表达式
   * @return 返回的XNode对象，如果不存在则返回null
   */
